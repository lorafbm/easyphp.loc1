    ...
    <div class="container">
                ...
                <fieldset>
                    ...
                    <form action="" method="post" role="form">
                        ...
                        <div class="form-group">
                            <input type="text" name="address" class="form-control" placeholder=" Адрес:город,улица,дом"
                                   value="<?php echo !empty($_SESSION['result']['address']) ? $_SESSION['result']['address'] : ''; ?>">
                            <?php if (!empty($_SESSION['error']['address'])) {
                                echo '<span style="color: red;">' . $_SESSION['error']['address'] . '</span>';
                            } ?>
                        </div>
                        <div class="form-group">
